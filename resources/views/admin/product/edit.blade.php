      ...
      <div class="card-header">
          <div class="row">
              <div class="col-md-8 card_top_title">
                  <i class="fa fa-gg-circle"></i> Update Product Information
              </div>
              <div class="col-md-4 text-right card_top_btn">
                  <a href="{{url('all_product')}}" class="btn btn-sm btn-info" ><i class="fa fa-th"></i> All Banner</a>
              </div>
          </div>
      </div>
            ...
            <div class="col-md-10 m-auto">
                <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group mg-b-10-force">
                            @php
                                ...
                                $subcategory = App\Subcategory::where('category_id',$product->category_id)->get();
                            @endphp
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label">Product Size: <span class="text-danger">*</span></label><br>
                          <input class="form-control" type="text" value="{{ $product->size }}" name="size" id="size" data-role="tagsinput">
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label">Product Color: <span class="text-danger">*</span></label><br>
                          <input class="form-control lg-4" type="text" value="{{ $product->color}}" name="color" data-role="tagsinput" id="color" >
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-6">
                        <div class="form-group">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label">Discount Price <span class="text-danger">*</span></label>
                          <input class="form-control" type="text" value="{{ $product->discount_price }}" name="discount_price"  placeholder="discount Price">
                        </div>
                      </div><!-- col-4 -->

                      <div class="col-lg-12">
                          <div class="form-group">
                          <label class="form-control-label">Product Details<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <input type="checkbox" name="mid_slider" value="1" @if($product->mid_slider == 1) checked @endif id="mid_slider" class="filled-in chk-col-red_light_blue">
                            <label for="mid_slider">Main Slider</label>
                        </div>

                        <div class="col-lg-4">
                            <input type="checkbox" name="hot_deal" value="1" @if($product->hot_deal == 1) checked @endif id="hot_deal" class="filled-in chk-col-red_light_blue">
                            <label for="hot_deal">Hot Deal</label>
                        </div>
                        <div class="col-lg-4">
                            <input type="checkbox" name="best_rated" value="1" @if($product->best_rated == 1) checked @endif id="best_rated" class="filled-in chk-col-red_light_blue">
                            <label for="best_rated">Best Rated</label>
                        </div>
                        <div class="col-lg-4">
                            <input type="checkbox" name="trend_product" value="1" @if($product->trend_product == 1) checked @endif id="trend_product" class="filled-in chk-col-red_light_blue">
                            <label for="trend_product">Trand Product</label>
                        </div>
                        <div class="col-lg-4">
                            <input type="checkbox" name="main_slider" value="1" @if($product->main_slider == 1) checked @endif id="main_slider" class="filled-in chk-col-red_light_blue">
                            <label for="main_slider">Main Slider</label>
                        </div>
                        <div class="col-lg-4">
                            <input type="checkbox" name="hot_new" value="1" @if($product->hot_new == 1) checked @endif id="hot_new" class="filled-in chk-col-red_light_blue">
                            <label for="hot_new">Hot New</label>
                        </div>
                      <div class="col-lg-4">
                        <input type="checkbox" name="buy_on" value="1" @if($product->buy_on == 1) checked @endif id="buy_on" class="filled-in chk-col-red_light_blue">
