          ...
          <div class="card card-outline-info">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-6 card_header_title">
                            <i class="fa fa-gg-circle"></i>Sub Category Create
                      </div>
                      <div class="col-md-6 card_header_button">
                            <a href="{{route('all_subcategory')}}" class="btn btn-sm btn-dark"><i class="fa fa-th"></i>All Sub-Category</a>
                      </div>
                      <div class="clr"></div>
                  </div>
              </div>
              <div class="card-body">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('name') ? ' has-error' : '' }}">
                  <label class="col-sm-3 col-form-label">Sub-Category Name:<span class="req_star">*</span></label>
                  <div class="col-sm-7">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('icon') ? ' has-error' : '' }}">
                  <label class="col-sm-3 col-form-label">Sub-Category Icon:<span class="req_star">*</span></label>
                  <div class="col-sm-7">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('image') ? ' has-error' : '' }}">
                  <label class="col-sm-3 col-form-label">Sub-Category Image:<span class="req_star">*</span></label>
                  <div class="col-sm-7">
